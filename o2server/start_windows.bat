...
@echo on
"%~dp0jvm\windows_java25\bin\java" -javaagent:"%~dp0console.jar" -server -Xms4g -Xmx4g -Duser.timezone=GMT+08 -XX:+HeapDumpOnOutOfMemoryError -XX:+UnlockExperimentalVMOptions -XX:+EnableJVMCI --module-path="%~dp0/commons/module_java25" --upgrade-module-path="%~dp0/commons/module_java25/compiler.jar;%~dp0/commons/module_java25/compiler-management.jar" -jar "%~dp0console.jar"
